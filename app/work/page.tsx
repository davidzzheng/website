      ...
      <ul className="space-y-8">
        <li className="space-y-2">
          ...
          <p className="text-sm">
            ...
            products, with the main objective of being to transform the company
            from a strictly email security to a broader cloud security platform.
          </p>
        </li>
        <li className="space-y-2">
          <div className="flex items-center justify-between">
          ...
          <p className="text-sm">
            ...
            stack, implementing frontend features that would help streamline our
            warehouse operations, as well as backend integrations with our
            last-mile carrier partners.
          </p>
        </li>
        <li className="space-y-2">
          <div className="flex items-center justify-between">
          ...
          <p className="text-sm">
            ...
            within our product pillar, paving the way for future projects to use
            modern web technologies instead of the XML-based service that powers
            the rest of Workday.
          </p>
        </li>
        <li className="space-y-2">
        ...
        <li className="space-y-2">
          ...
          <p className="text-sm">
            ...
            that has won numerous awards and accolades at the international
            level. During my time there, I lead a team to a world championship
            qualification spot as a first-time captain/driver. I also helped
            push forward software-oriented solutions that took advantage of the
            sensors available to us, and open-sourced our code for our
            underclassmen to learn from and build upon after we graduated.
          </p>
        </li>
      </ul>
    </div>
